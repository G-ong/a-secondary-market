...
<template>
  ...
  <form>
    ...
    <button @click="submitForm($event)" class="btn1">修改</button>
</form>
  <div>
    <!-- 左半部分 -->
    <div class="left">
  ...
  export default {
    ...
    methods: {          
      getFile(event) {
          ...
          formData.append('goodsId',localStorage.getItem('change'))
            let config = {
              headers: {
...
//  修改提交商品
            axios.post('http://5101g0918f.wicp.vip/goods/resetSubmitted', formData, config).then(function (response) {
