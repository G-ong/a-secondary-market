...
//                   goodsName:'ABC'
//               }
//               axios.post('http://bbbbbblack.free.idcfengye.com/goods/showGoodsMessage',data,
//                 // headers: {
//                 //     'Content-Type':'application/json'
//                 // },
//                 )
//               .then((res)=>{
//                   this.imgurl='http://bbbbbblack.free.idcfengye.com'+res.data.data.goodsPicture;
//                   console.log('http://bbbbbblack.free.idcfengye.com'+res.data.data.goodsPicture); 
//               })
//               .catch((error)=>{
//                   console.log(error)  
//               })
